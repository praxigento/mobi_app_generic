...
{
    /** @var  \Praxigento\App\Generic2\Cli\Init\Sub\CustomerGroups */
    private $obj;

    public function setUp()
    {
        parent::setUp();
        $this->obj = ObjectManager::getInstance()->create(\Praxigento\App\Generic2\Cli\Init\Sub\CustomerGroups::class);
    }

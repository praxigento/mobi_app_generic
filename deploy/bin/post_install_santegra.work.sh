#!/bin/sh
##
#   Setup Magento instance for Santegra migration after install with Composer.
...
echo "Init customer groups and downline tree."
php ${DIR_MAGE}/bin/magento prxgt:test:downline-init
